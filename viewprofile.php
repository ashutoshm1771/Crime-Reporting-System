...
<h1>profile Information</h1>
        <form action="updateprofile.php" method="post"  enctype="multipart/form-data" name="">
		 <div>
		  ...
		  <p>&nbsp;</p>
		  <div>
		    <h2>&nbsp;&nbsp;<span class="style16">  Log-in details:</span></h2>
		  </div>             
           <p>&nbsp;</p>            
           ...
           <table width="565" align="center" cellpadding="10" cellspacing="20">
             <tr bgcolor="#993366">
			  ...
			  <tr bgcolor="#999999">
               <td align="right" valign="middle" bgcolor="#FFFFFF">
			   <span class="style19" style="color: #000000">Old Password: </span>
			  ...
			  <tr bgcolor="#993366">
			    <td height="22" align="right" valign="middle" bgcolor="#FFFFFF"><span class="style19" style="color: #000000">New Password:</span>              
			    <td align="left" bgcolor="#FFFFFF"><span class="style15">
			      <input type="text" size="24" value="<?php echo $record["password"]; ?>" 
		     ...
		     <tr bgcolor="#993366">
			   ...
			   <span class="style19" style="color: #000000">Conform Password: </span>
               <td align="left" bgcolor="#FFFFFF"><span class="style15">              
