	...
	<div id="container" class="wrapper-container">
       ...
       <div class="corner-bottom-right">
        <form action="chkFIRreg3.php" method="post" enctype="multipart/form-data" name="form1">
		 <div>
		   <h2><span class="componentheading"><em>Step:3. Fill the following FIR  details</em></span></h2>
		   <h2><span class="componentheading"><em>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(Information about victim):</em></span>
		     </h2>
		 </div>             
           <p>&nbsp;</p>
           <table width="770" height="323" border="0" align="center" cellpadding="10" cellspacing="5">
             ...
             <tr bgcolor="#993366">
               <td align="right" valign="middle" bgcolor="#FFFFFF"><span class="style19" style="color: #000000">Email-id:</span>             
               <td align="left" bgcolor="#FFFFFF">
