...
<div id="content">
	...
	<div id="container" class="wrapper-container">
       ...
       <div class="corner-bottom-right">
        <form action="chkregistration.php" method="post"  enctype="multipart/form-data" name="form1">
		 <div>
		   <h2><span class="componentheading"><em>Step:1.Fill the following registration details:</em></span></h2>
		 </div>             
           <p>&nbsp;</p>
             ...
             <tr bgcolor="#999999">
               <td height="27" align="right" valign="middle" bgcolor="#FFFFFF">
			     <blockquote>
			       <blockquote>
			         <blockquote>
			           <p><span class="style19" style="color: #000000">Your recent photo:</span></p>
			           </blockquote>
			       </blockquote>
			     </blockquote>
               <td align="left" bgcolor="#FFFFFF"><span class="style15 style3">
	...
	class="article_separator">&nbsp;</span></div>
		  <p>&nbsp;</p>
		  <div>
		    <h2>&nbsp;&nbsp;<span class="componentheading"><em> Step:2. Fill the following Log-in details:</em></span></h2>
		  </div>             
           <p>&nbsp;</p>            
           
           <table width="565" align="center" cellpadding="20" cellspacing="20">
             <tr bgcolor="#993366">
