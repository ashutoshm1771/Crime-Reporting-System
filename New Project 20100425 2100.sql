...
--
-- Definition of table `mstr_missingcitizens`
--

DROP TABLE IF EXISTS `mstr_missingcitizens`;
CREATE TABLE `mstr_missingcitizens` (
  ...
  CONSTRAINT `FK_mstr_missingcitizens_3` FOREIGN KEY (`username`) REFERENCES `mstr_login` (`username`),
  CONSTRAINT `FK_mstr_missingcitizens_1` FOREIGN KEY (`city_id`) REFERENCES `mstr_city` (`city_id`),
  CONSTRAINT `FK_mstr_missingcitizens_2` FOREIGN KEY (`area_id`) REFERENCES `mstr_area` (`area_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
/*!40000 ALTER TABLE `mstr_missingcitizens` DISABLE KEYS */;
/*!40000 ALTER TABLE `mstr_missingcitizens` ENABLE KEYS */;
