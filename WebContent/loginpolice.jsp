...
<html lang="en" dir="ltr">
 ...
 <link rel="icon" href="https://cdn4.iconfinder.com/data/icons/pictype-free-vector-icons/16/home-128.png">
  ...
  <body class="body1">
       ...
       <a class="navbar-brand" href="#">Welcome Indian Police Crime Branch</a>
  <!-- Navbar content -->
       </nav>
       <br>
       <br>
  ...
  <div class="container">
        <div class="jumbotron">
        <h1 class="display-4" id="header">Police Login</h1>
        <br>
        <hr class="my-4">
        <br>
    <form method="post" action="policevali.jsp">
      ...
      <div class="text-center">
        New User?
        <a style="text-align:right" name="new" href="policereg.jsp">Register now!</a>
        <div class="text-center">
        </div>
          </div>
