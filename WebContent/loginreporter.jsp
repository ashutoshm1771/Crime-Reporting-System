...
<html lang="en" dir="ltr">
 ...
 <link rel="icon" href="https://cdn4.iconfinder.com/data/icons/pictype-free-vector-icons/16/home-128.png">
  ...
  <div class="container">
        <div class="jumbotron">
        <h1 class="display-4" id="header">Reporter Login</h1>
        <br>
        <hr class="my-4">
        <br>
    <form method="post" action="reportervali.jsp">
      ...
      <div class="text-center">
        New User? -->
        <a style="text-align:right" name="new" href="reporterreg.jsp">Register now!</a>
        <div class="text-center">
        </div>
          </div>
