...
CREATE TABLE `mstr_officer` (
  ...
  KEY `FK_mstr_officer_1` (`poilcestation_id`) USING BTREE,
  CONSTRAINT `FK_mstr_officer_1` FOREIGN KEY (`poilcestation_id`) REFERENCES `mstr_policestation` (`poilcestation_id`),
...
INSERT INTO `mstr_officer` (`username`,`Jdate`,`Ldate`,`desi_id`,`poilcestation_id`) VALUES 
 ('mayur','0000-00-00 00:00:00','0000-00-00 00:00:00',1,1);
